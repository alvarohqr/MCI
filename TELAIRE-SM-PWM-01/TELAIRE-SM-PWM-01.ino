...
//P2.0
#define PM10_IN_PIN 19   //input for PM2 & 10 signal, P1
//P2_2
#define PM2_IN_PIN 18  //input for PM10 signal, P2, used this way initially signals are sorted aroound line 170; 
